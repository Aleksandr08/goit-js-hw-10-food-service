    ...
    [0], {
        ...
        QfWi: function (e, n, t) {
            ...
            var a = t("f+ZA"),
                i = t("o4H4"),
                r = t.n(i);
            document.querySelector(".menu").insertAdjacentHTML("afterbegin", r()(a));
            var o = "light-theme",
                c = "dark-theme",
                l = document.querySelector("#theme-switch-control"),
                s = localStorage.getItem("theme"),
                p = document.querySelector("body");
            s ? (p.className = s, s === c && (l.checked = !0)) : p.className = o, l.addEventListener("change", (function (e) {
                e.target.checked ? (p.className = c, localStorage.setItem("theme", c)) : (p.className = o, localStorage.setItem("theme", o))
            }))
        },
        "f+ZA": function (e) {
        ...
        o4H4: function (e, n, t) {
            ...
            e.exports = (a.default || a).template({
                1: function (e, n, t, a, i) {
                    var r, o, c = null != n ? n : e.nullContext || {},
                        l = e.hooks.helperMissing,
                        s = "function",
                        p = e.escapeExpression,
                        m = e.lookupProperty || function (e, n) {
                            if (Object.prototype.hasOwnProperty.call(e, n)) return e[n]
                        };
                    return '<li class="menu__item">\r\n    <div class="card">\r\n        <img src="' + p(typeof (o = null != (o = m(t, "image") || (null != n ? m(n, "image") : n)) ? o : l) === s ? o.call(c, {
                        name: "image",
                        hash: {},
                        data: i,
                        loc: {
                    ...
                    }) : o) + '" alt="' + p(typeof (o = null != (o = m(t, "name") || (null != n ? m(n, "name") : n)) ? o : l) === s ? o.call(c, {
                        name: "name",
                        hash: {},
                        data: i,
                        loc: {
                    ...
                    }) : o) + '" class="card__image" />\r\n        <div class="card__content">\r\n            <h2 class="card__name">' + p(typeof (o = null != (o = m(t, "name") || (null != n ? m(n, "name") : n)) ? o : l) === s ? o.call(c, {
                        name: "name",
                        hash: {},
                        data: i,
                        loc: {
                    ...
                    }) : o) + '</h2>\r\n            <p class="card__price">\r\n                <i class="material-icons">\r\n                    monetization_on\r\n                </i>\r\n                ' + p(typeof (o = null != (o = m(t, "price") || (null != n ? m(n, "price") : n)) ? o : l) === s ? o.call(c, {
                        name: "price",
                        hash: {},
                        data: i,
                        loc: {
                    ...
                    }) : o) + ' кредитов\r\n            </p>\r\n\r\n            <p class="card__descr">\r\n                ' + p(typeof (o = null != (o = m(t, "description") || (null != n ? m(n, "description") : n)) ? o : l) === s ? o.call(c, {
                        name: "description",
                        hash: {},
                        data: i,
                        loc: {
                    ...
                    }) : o) + '\r\n            </p>\r\n\r\n            <ul class="tag-list">\r\n' + (null != (r = m(t, "each").call(c, null != n ? m(n, "ingredients") : n, {
                        name: "each",
                        hash: {},
                        fn: e.program(2, i, 0),
                        inverse: e.noop,
                ...
                2: function (e, n, t, a, i) {
                    return '                <li class="tag-list__item">' + e.escapeExpression(e.lambda(n, n)) + "</li>\r\n"
                },
                compiler: [8, ">= 4.3.0"],
                main: function (e, n, t, a, i) {
                    var r;
                    return null != (r = (e.lookupProperty || function (e, n) {
                        if (Object.prototype.hasOwnProperty.call(e, n)) return e[n]
...
//# sourceMappingURL=main.219e972fc36a4ec13016.js.map 